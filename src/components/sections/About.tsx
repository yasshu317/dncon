          ...
          <div className="grid md:grid-cols-3 gap-6">
            {about.whatWeDo.map((item) => (
              <div key={item.title} className="card p-8 text-center group hover:shadow-lg transition-shadow">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 border border-blue-200 flex items-center justify-center mx-auto mb-5 group-hover:scale-105 transition-transform">
                  <IconResolver name={item.icon} className="w-6 h-6 text-blue-600" />
                </div>
